	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		if ( $is_form_editor ) {
			...
			if ( $this->emailConfirmEnabled ) {
				...
				$email_value           = ! $is_entry_detail && is_array( $value ) ? esc_attr( $value[0] ) : $value;
				$confirmation_value    = ! $is_entry_detail && is_array( $value ) ? esc_attr( $value[1] ) : '';
