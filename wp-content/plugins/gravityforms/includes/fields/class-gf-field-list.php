...
class GF_Field_List extends GF_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
        ...
        $label_target_shim = sprintf( '<input type=\'text\' id=\'input_%1$s_%2$s_shim\' style=\'position:absolute;left:-999em;\' onfocus=\'jQuery( "#field_%1$s_%2$s table tr td:first-child input" ).focus();\' />', $form_id, $this->id );
