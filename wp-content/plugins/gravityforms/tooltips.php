...
$__gf_tooltips = array(
	...
	'form_field_label_placement'                  => '<h6>' . __( 'Label Visibility', 'gravityforms' ) . '</h6>' . __( 'Select the label placement for this field.  Labels can be top aligned above a field, left aligned to the left of a field, right aligned to the left of a field or hidden.', 'gravityforms' ),
	...
	'form_field_default_input_values'             => '<h6>' . __( 'Default Values', 'gravityforms' ) . '</h6>' . __( 'If you would like to pre-populate the value of a field, select this option.', 'gravityforms' ),
	...
	'import_select_file'                          => '<h6>' . __( 'Select File', 'gravityforms' ) . '</h6>' . __( 'Click the Choose File button to upload a Gravity Forms export file from your computer.', 'gravityforms' ),
