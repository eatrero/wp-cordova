	...
	public static function output_field_scripts( $echo = true ){
		...
		foreach ( GF_Fields::get_all() as $gf_field ) {
			if ( $gf_field->is_conditional_logic_supported() ) {
				$script_str .= 'gform.addFilter("gform_is_conditional_logic_field", function(isConditionalLogicField, field){return field.type == "' . $gf_field->type . '" ? true : isConditionalLogicField;});';
			}
		}
